...
import type { MainMenuItemConfig } from '@/config/mainMenu'
...
function itemClick(event: Event, item: MainMenuItemConfig) {
  if (item.disabled) {
  ...
  setActiveMenuItem(foundItemKey ?? itemKey.value)
}

function checkActiveRoute(item: MainMenuItemConfig) {
