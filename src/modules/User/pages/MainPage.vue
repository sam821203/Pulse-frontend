...
import type { UserData } from '../model/interface'
...
const initUserInfo = async () => {
  if (!userInfo.value) {
    ...
    userData.name = userInfo.value.name
    userData.roles = userInfo.value.roles
  }
}
            ...
            <div class="flex flex-col items-center">
              ...
              <div class="mt-6 flex flex-wrap gap-4 justify-center">
                <a href="#" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded"
                  >Contact</a
                >
                <a href="#" class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded"
                  >Resume</a
                >
              </div>
            </div>
